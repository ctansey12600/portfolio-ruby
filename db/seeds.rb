...
web_data = [
  ...
  links: [
    {
      name: "The Anonymous Artist",
      url: "https://ctansey12600.github.io/the-anonymous-artist/"
    },
    {
      name: "Github",
      url: "https://github.com/ctansey12600/the-anonymous-artist"
    }]
  },
  {
...
blog_data = [
  ...
  links: [
    {
      name: "Using Styled-Components",
      url: "https://medium.com/@ctansey12600/using-styled-components-to-alternate-colors-9da69cbbbe09"
    }]
  },
  {
  ...
  links: [
    {
      name: "Creating My First Project",
      url: "https://medium.com/@ctansey12600/creating-my-first-project-806b65bd934c"
    }]
  },
  {
  ...
  links: [
    {
      name: "Doing a 180 on life...",
      url: "https://medium.com/@ctansey12600/doing-a-180-on-life-2f1ab824249e"
    }]
  }
]

# Make Portfolio Data
web = Portfolio.create(name: "Website Development")
graphic = Portfolio.create(name: "Graphic Design")
blog = Portfolio.create(name: "Blog")

# Make Project Data for web
web_data.each do |d|
...
graphic_data.each do |d|
  project = Project.create(
    name: d[:name],
    languages: d[:languages],
    date_made: d[:date_made],
    purpose: d[:purpose],
    portfolio_id: graphic.id
  )
